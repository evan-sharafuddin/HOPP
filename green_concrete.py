...
# report seems to use clinker and cement interchangibly. clinker is obviously the cost-intensive 
# and resource intensive portion of cement production, so I'm assuming the model assumes that 
# the gypsum and other materials added to the clinker to create cement are neglible. 
#   no mention of grinders, etc. 
#   maybe this model is just specific to clinker?
...
class ConcretePlant:
    ...
    def run_profast_for_cement(self):
        ...
        # --- CAPEX --- (all values in M€), section 5.1.2
